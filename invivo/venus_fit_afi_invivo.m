function venus_fit_afi_invivo(bidsFolder)
    ...
    for ii = 1:length(sessions)
        ...
        FitResultsSave_BIDS(FitResults,[AFI1 '.nii.gz'],'invivo','targetDir',[bidsFolder filesep 'derivatives'],'sesFolder',true,'ses',sessions{ii},'injectToJSON',addDescription);
