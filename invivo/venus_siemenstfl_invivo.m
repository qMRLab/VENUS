function venus_siemenstfl_invivo(bidsFolder)
...
% Otherwise just a division of fmap.
    ...
    for ii = 1:length(sessions)
        ...
        pth = [bidsFolder filesep 'sub-invivo' filesep 'ses-' sessions{ii} filesep 'fmap' filesep ];
        ...
        FitResultsSave_BIDS(FitResults,[FMAP '_resliced.nii'],'invivo','targetDir',[bidsFolder filesep 'derivatives'],'sesFolder',true,'ses',sessions{ii},'injectToJSON',addDescription);
    end
